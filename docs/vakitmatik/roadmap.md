...
| 2.2 Cami Saati Fiyatları | `/cami-saati-fiyatlari/` | Model/ölçü bazlı fiyat sorma akışı ve katalog görünümü canlıya alındı ve doğrulandı | Ads final URL ayrı onay |
